...
class Backpropagation:
    ...
    # Turunan fungsi tanh (asumsi x = output tanh)
    ...
    def plot_error(self, errors, epoch):
        ...
        plt.annotate(
            ...
            xytext=(max(1, epoch - len(errors) * 0.2), final_error + 0.05),
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig("error_plot_backpropagation.png")
        plt.show()
    ...
    def fit(self, X, t):
        ...
        with open("hasilBackpropagation.txt", "w") as f:
            ...
            for epoch in range(self.epoch):
                ...
                for xi, target in zip(X, t):
                    ...
                    f.write(f"Aktivasi hidden layer (tanh):\n{h}\n\n")
                    ...
                    f.write(f"Aktivasi output layer (tanh):\n{y}\n")
                    ...
                    self.w_hidden += np.dot(xi.reshape(self.n_input, 1), d_h) * self.alpha
                ...
                f.write(f"SSE epoch ke-{epoch + 1}: {average_error}\n")
        ...
        print("Selesai! Hasil disimpan di hasilBackpropagation.txt")
